         ...
         <div class="protask">
            <div class="view">
               <div class="viewHeader">
                  ...
                  <div class="functions">
                     <a href="javascript:;" onclick='OpenModalForCreateTask("<?php echo $this->session->userdata('current_teacher_id')?>" , "<?php  echo $proposal_id; ?>")'class="button active">Add New Task</a>
                                 ...
                                 <div class="list">
                                    ...
                                    <div class="row" style="border-radius: 10px;border: 2px solid #73AD21;padding: 2px; margin:1%;">
                                      <!-- <h4> <strong>Tasks</strong></h4> -->
                                       ...
                                       <div class="col-md-3">
                                          <span>
                                             <input style="margin-top:5px;" type="button" class="btn btn-info" value="On Going">
                                             <a style="margin-top:5px;" type="button" class="btn btn-success" href="<?php echo site_url('ProjectBoard/CompleteTask/'.$task->task_id); ?>">Completed </a>
                                             <a type="button"  href="<?php echo site_url('ProjectBoard/RejectTask/'.$task->task_id )?>" class="btn btn-danger">Reject This Task</a>
                                          </span>
                              ...
                              <div class="content">
                                 ...
                                 <div class="list">
                                    ...
                                    <div class="row" style="border-radius: 10px;border: 2px solid #73AD21;padding: 2px; margin:1%;">
                                       ...
                                       <div class="col-md-3">
                                          <p>Posted By : <?php echo $link->student_id; ?></p>
                                       </div>
                                       <div class="col-md-1"><?php echo date("h:i A", strtotime($link->link_create_at)); ?></span>
                                          &nbsp;
                                       </div>
                                       <div class="col-md-1">
                                          <span>
                              ...
                              <div class="content">
                                 ...
                                 <div class="list">
                                    ...
                                    <div class="row" style="border-radius: 10px;border: 2px solid #73AD21;padding: 2px; margin:1%;">
                                       ...
                                       <div class="col-md-2">
                                          <p>Uploaded By :<?php echo $file->uploaded_by; ?></p>
                                       </div>
                                       <div class="col-md-1">
